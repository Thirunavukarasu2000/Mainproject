...
public class HardAssertionPractice 
{
	...
	//	Assert.assertEquals(actualName.equals(expectedName));
	//	Assert.assertEquals(actualName.equals(expectedName), true);
		System.out.println("Hard Assrertion strict level completed");
	...
	public void containsLevelComparison()
	{
		...
		System.out.println("Hard Assrertion contains level completed");
